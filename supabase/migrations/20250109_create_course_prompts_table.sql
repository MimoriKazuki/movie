...
-- インデックス
CREATE INDEX idx_course_prompts_course_id ON course_prompts(course_id);
CREATE INDEX idx_course_prompts_prompt_id ON course_prompts(prompt_id);
CREATE INDEX idx_course_prompts_order ON course_prompts(course_id, order_index);
